...
def create_recur(request):
    ...
    return render(request,'recurpage.html',{'item':item,'cus':cus,'pay':pay,'company':company})
...
def get_cust_mail(request):
    ...
    return JsonResponse({"status": " not", 'email': email,'comp':comp,'site':site,'mob':mob})
    return redirect('/')
# .......................................customer_details
def customer_details(request):
    customer_name = request.GET.get('customer')
    try:
        customers = customer.objects.get(customerName=customer_name)
        # Assuming 'name', 'address', and 'email' are fields in the Customer model
        customer_data = {
            'name': customers.companyName,
            'address': customers.customerEmail,
            'email': customers.customerMobile,
